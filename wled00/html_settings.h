...
hr{margin:2px auto}body{text-align:center;background:#000;margin:0;font-family:sans-serif}button.settingsbutton{width:45vw;min-width:300px;margin:8px auto;display:flex;padding:10px;align-items:center;justify-content:center;border-radius:29px;border:1px solid #2c2c2c;background:#2c2c2c;color:var(--white,#fff);text-align:center;font-size:20px;font-style:normal;font-weight:600;line-height:normal}.section-heading{color:#4b9dc9;text-align:center;font-weight:550;font-size:25px;margin:0 0 5px 0}
...
style="outline:0;cursor:pointer;padding:5px 10px;margin:10px;text-transform:uppercase;font-size:15px;font-style:normal;font-weight:550;line-height:normal;border:1px solid var(--black-500,#909090);background:var(--white,#fff);color:var(--black-900,#000);border-radius:25px;width:40px">
?</button></div><button type="button" onclick="B()" 
style="outline:0;cursor:pointer;padding:5px 10px;margin:10px;text-transform:uppercase;font-size:15px;font-style:normal;font-weight:550;line-height:normal;border:1px solid var(--black-500,#909090);background:var(--white,#fff);color:var(--black-900,#000);border-radius:25px">
Back</button><hr><div 
...
Back</button><button 
style="outline:0;cursor:pointer;padding:5px 10px;margin:10px;text-transform:uppercase;font-size:15px;font-style:normal;font-weight:550;line-height:normal;border:1px solid var(--black-500,#909090);background:var(--white,#fff);color:var(--black-900,#000);border-radius:25px" 
type="submit">Save</button></div><span id="lssuc" 
...
</span><div class="middle"><h2>Usermod Setup</h2><div id="um">
Loading settings...</div></div><div style="margin-top:50px;height:1px"></div>
